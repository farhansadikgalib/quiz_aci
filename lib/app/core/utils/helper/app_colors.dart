...
class AppColors {
  static const primaryColor = Color(0xFF0058A9);
  static const primaryAccentColor = Color(0xFF54ADFF);
  static const buttonColor = Color(0xFF0058A9);
  static const textColor = Color(0xFF919191);
  static const filterSectionColor = Color(0xFFF5F5F5);
  static const secondaryColor = Color(0xFFEFF5FA);

  static final transparentPure = Colors.white.withOpacity(0.0);

  static const hintTextColor = Color(0xFFC2C2C2);

  ///Core Color
  static const coreWidgetColor = Color(0xFF533F5A);
  static const green = Color(0xFF00CA7F);
  ...
  static const liteGray = Color(0xffE2E2E2);
